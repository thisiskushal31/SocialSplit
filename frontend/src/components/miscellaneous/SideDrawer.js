...
import { Input, Spinner, Image } from "@chakra-ui/react";
import ChatLoading from "../ChatLoading";
import UserListItem from "../userAvatar/UserListItem";
import NotificationBadge from "react-notification-badge";
import { Effect } from "react-notification-badge";
import { getSender } from "../../config/ChatLogics";
import Icons from "../../assets/SocialSplit_Icon.svg"
      ...
      >
        <Tooltip label="Search Users to chat" hasArrow placement="bottom-end">
          <Button variant="ghost" bg ='blue.700' onClick={onOpen} color="white"
            _hover={{ background: "#174a4a", color:"yellow.400" }} _active={{ background: "#174a4a", color:"yellow.400" }}>
        ...
        <div>
          ...
          <Menu>
            ...
            <MenuList bg = "#174a4a" borderColor="black" borderWidth="2px">
              <ProfileModal user={user}>
                <MenuItem fontWeight="bold" color="white" _hover={{background: "#112a2a"}}  >
                  My Profile
                </MenuItem>{" "}
              </ProfileModal>
              <MenuDivider/>
              <MenuItem fontWeight="bold" color="white" onClick={logoutHandler} _hover={{background: "#112a2a"}}>
                Logout
              </MenuItem>
            </MenuList>
          </Menu>
